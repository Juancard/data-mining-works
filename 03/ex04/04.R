...
hist(tt.original[tt.original<300], breaks=30, main = "Original", ylim=c(0,2000), xlab = "Tiempo de traslado")
hist(tt.mean_replace[tt.mean_replace<300], breaks=30, main = "Mean", ylim=c(0,2000), xlab = "Tiempo de traslado")
hist(tt.hotdeck[tt.mean_replace<300], breaks=30, main = "Hot-deck", ylim=c(0,2000), xlab = "Tiempo de traslado")
